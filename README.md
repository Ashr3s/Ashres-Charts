...
<p> Hello! Here is a collection of some of the music charts I create, typically pertaining to the Billboard Hot 100 chart (<a href=”https://www.billboard.com/charts/hot-100/”></a>), including Billboard Hot 100 Projections (released on Saturday/Sunday) and other custom charts. These charts are also typically available on my Twitter: (<a href="https://twitter.com/ashres_charts"></a>). I also work on these charts with online friends, we work on a group account to publish these charts. These charts can be viewed at: (<a href="https://twitter.com/chartessentials"></a>). Note that none of the metrics displayed are official, all values are estimated.
